...
// THE MACHINA LANDING (candidate front door). The founder's chosen theme ([[design-direction-machina]]):
// pure black/white, monospace, zero-radius, giant uppercase display, a system ticker. Static + server-
// rendered. Kept at /machina (not /) so the working "prove it" demo on / is untouched until the founder
// blesses the swap. HONESTY FLOOR: the mockup's stat numbers were placeholders — replaced here with TRUE
// statements, no invented metrics ([[crack-audit-and-no-fake-proof]]).
    ...
    <div className="min-h-screen bg-white font-mono text-black">
      ...
      <header className="flex items-center justify-between border-b-2 border-black px-6 py-4">
        ...
        <nav className="flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.15em]">
          ...
          <a href="/connect" className="bg-black px-4 py-2 text-white hover:bg-[#8C3A22]">Get started →</a>
        </nav>
      </header>
      ...
      <section className="border-b-2 border-black px-6 py-16">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <a href="/connect" className="bg-black px-8 py-4 text-sm font-bold uppercase tracking-wider text-white hover:bg-[#8C3A22]">Start for free →</a>
      ...
      <section className="px-6 py-16 text-center">
        ...
        <a href="/connect" className="mt-8 inline-block bg-black px-10 py-4 text-sm font-bold uppercase tracking-wider text-white hover:bg-[#8C3A22]">
          Get started →
        </a>
      </section>
